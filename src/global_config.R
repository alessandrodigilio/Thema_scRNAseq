...
# output directories by analysis block
atlas_results_dir       <- file.path(results_dir, "atlas")
macrophage_results_dir  <- file.path(results_dir, "macrophages")
endothelial_results_dir <- file.path(results_dir, "endothelial")
fibroblast_results_dir  <- file.path(results_dir, "fibroblasts")
trajectory_results_dir  <- file.path(results_dir, "trajectory_analysis")

atlas_figures_dir       <- file.path(figures_dir, "atlas")
macrophage_figures_dir  <- file.path(figures_dir, "macrophages")
endothelial_figures_dir <- file.path(figures_dir, "endothelial")
fibroblast_figures_dir  <- file.path(figures_dir, "fibroblasts")
trajectory_figures_dir  <- file.path(figures_dir, "trajectory_analysis")
paper_figures_dir       <- file.path(figures_dir, "paper")

qc_dir <- file.path(atlas_results_dir, "qc")
...
dir.create(atlas_results_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(macrophage_results_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(endothelial_results_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(fibroblast_results_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(trajectory_results_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(atlas_figures_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(macrophage_figures_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(endothelial_figures_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(fibroblast_figures_dir, recursive = TRUE, showWarnings = FALSE)
dir.create(trajectory_figures_dir, recursive = TRUE, showWarnings = FALSE)
...
filtering_log_dir   <- file.path(atlas_results_dir, "logs")
