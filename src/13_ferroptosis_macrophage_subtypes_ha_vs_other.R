...
write.csv(summary_subtype_out, file.path(res_dir, "ferroptosis_score_by_macrophage_subtype_HA_vs_other.csv"), row.names = FALSE)
...
if ("sample_id" %in% colnames(obj@meta.data)) {
  ...
  write.csv(summary_sample_out, file.path(res_dir, "ferroptosis_score_by_sample_macrophage_subtype_HA_vs_other.csv"), row.names = FALSE)
}

# ferroptosis score UMAP in macrophage subset
