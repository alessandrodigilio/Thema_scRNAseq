...
fig_dir <- file.path(fibroblast_figures_dir, "destructive_lining_fibroblast_final_annotation")
res_dir <- file.path(fibroblast_results_dir, "destructive_lining_fibroblast_final_annotation")
