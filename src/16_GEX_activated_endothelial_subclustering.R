# ---------------------------------------
# 16_GEX_activated_endothelial_subclustering.R
# Subclustering of activated endothelial cells
# ---------------------------------------
...
OUTPUT_SUBSET_OBJECT <- file.path(OUT_DIR, "gex_activated_endothelial_subclustered.rds")
OUTPUT_FULL_OBJECT <- file.path(OUT_DIR, "gex_annotated_endothelial_subclusters.rds")
...
write.csv(
  cluster_summary,
  file.path(RES_DIR, "activated_endothelial_cluster_resolution_summary.csv"),
  row.names = FALSE
)
...
write.csv(
  markers,
  file.path(RES_DIR, "all_markers_activated_endothelial_subclusters.csv"),
  row.names = FALSE
)
...
write.csv(
  top_markers_save,
  file.path(RES_DIR, "top_markers_per_activated_endothelial_subcluster.csv"),
  row.names = FALSE
)
...
write.csv(
  cluster_review,
  file.path(RES_DIR, "activated_endothelial_subcluster_review_table.csv"),
  row.names = FALSE
)
