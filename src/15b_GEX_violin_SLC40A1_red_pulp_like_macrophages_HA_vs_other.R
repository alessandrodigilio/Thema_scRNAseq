# ===============================================================
#   15b_GEX_violin_SLC40A1_red_pulp_like_macrophages_HA_vs_other.R
# ===============================================================

# Simple sample-level boxplot for one gene in the red-pulp-like resident
# macrophage subtype comparing HA vs other.
...
FIG_DIR <- file.path(FIGURES_DIR, "macrophage_gene_violin")
dir.create(FIG_DIR, recursive = TRUE, showWarnings = FALSE)

# Set parameters
GENE_TO_PLOT <- "SLC40A1"
GROUP_COL <- "condition"
SAMPLE_COL <- "sample_id"
SUBTYPE_COL <- "macrophage_subtype"
TARGET_SUBTYPE <- "Red-pulp-like resident macrophages (MERTK+)"
GROUP_LEVELS <- c("other", "HA")
GROUP_COLORS <- c("other" = "#B65A5A", "HA" = "#5B8DB8")
BOX_ALPHA <- 0.9
OUTPUT_FILE <- file.path(FIG_DIR, "boxplot_SLC40A1_red_pulp_like_resident_macrophages_HA_vs_other.png")
...
# Keep only the target macrophage subtype
