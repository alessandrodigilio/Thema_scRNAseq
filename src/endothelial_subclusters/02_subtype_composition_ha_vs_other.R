...
# compare endothelial subtype fractions between HA and other samples
...
# load endothelial-annotated object
...
cell_types <- names(endothelial_subtype_colors)
...
ggsave(file.path(fig_dir, "endothelial_subtype_fraction_HA_vs_other_boxplots.png"), p_box, width = 12, height = 9, dpi = 600)

cat("\n============================================================\n")
cat("Endothelial composition analysis complete.\n")
