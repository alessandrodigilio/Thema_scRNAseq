...
fig_dir <- file.path(endothelial_figures_dir, "activated_endothelial_subclustering")
res_dir <- file.path(endothelial_results_dir, "activated_endothelial_subclustering")
