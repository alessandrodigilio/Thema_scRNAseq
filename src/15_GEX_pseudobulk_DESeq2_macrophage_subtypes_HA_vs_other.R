# ===============================================================
#   15_GEX_pseudobulk_DESeq2_macrophage_subtypes_HA_vs_other.R
# ===============================================================
...
write.csv(
  summary_df,
  file.path(RES_DIR, "deseq2_pseudobulk_summary_by_macrophage_subtype.csv"),
  row.names = FALSE
)
...
write.csv(
  deg_summary_df,
  file.path(RES_DIR, "deseq2_significant_genes_summary_macrophage_subtypes.csv"),
  row.names = FALSE
)
