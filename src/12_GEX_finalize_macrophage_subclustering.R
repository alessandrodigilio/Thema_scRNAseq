# ---------------------------------------
# 12_GEX_finalize_macrophage_subclustering.R
# Final macrophage subcluster annotation and plotting
# ---------------------------------------
...
INPUT_SUBSET_OBJECT <- file.path(DATA_DIR, "integrated_object", "gex_macrophages_subclustered.rds")
INPUT_FULL_OBJECT <- file.path(DATA_DIR, "integrated_object", "gex_annotated_macrophage_subclusters.rds")
...
OUTPUT_FULL_OBJECT <- file.path(OUT_DIR, "gex_annotated_macrophage_states.rds")
...
RED_PULP_LIKE_FEATURES <- c(
  ...
  "SLC48A1",  # HRG-1, heme transporter from phagolysosome to cytosol
  "HMOX1",    # HO-1, heme degradation and iron recycling
...
write.csv(
  ...
  file.path(RES_DIR, "macrophage_subcluster_annotation_table.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(RES_DIR, "macrophage_canonical_marker_table.csv"),
  row.names = FALSE
)
