# ---------------------------------------
# 11_GEX_macrophage_subclustering.R
# Subclustering of synovial macrophages
# ---------------------------------------
...
OUTPUT_SUBSET_OBJECT <- file.path(OUT_DIR, "gex_macrophages_subclustered.rds")
OUTPUT_FULL_OBJECT <- file.path(OUT_DIR, "gex_annotated_macrophage_subclusters.rds")
...
write.csv(
  cluster_summary,
  file.path(RES_DIR, "macrophage_cluster_resolution_summary.csv"),
  row.names = FALSE
)
...
write.csv(
  markers,
  file.path(RES_DIR, "all_markers_macrophage_subclusters.csv"),
  row.names = FALSE
)
...
write.csv(
  top_markers_save,
  file.path(RES_DIR, "top_markers_per_macrophage_subcluster.csv"),
  row.names = FALSE
)
...
write.csv(
  cluster_review,
  file.path(RES_DIR, "macrophage_subcluster_review_table.csv"),
  row.names = FALSE
)
