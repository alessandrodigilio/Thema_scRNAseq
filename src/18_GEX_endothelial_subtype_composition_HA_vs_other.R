# ===============================================================
#   18_GEX_endothelial_subtype_composition_HA_vs_other.R
# ===============================================================
...
write.csv(
  ...
  file.path(RES_DIR, "endothelial_subtype_fraction_by_sample.csv"),
  row.names = FALSE
)
...
write.csv(
  stat_df,
  file.path(RES_DIR, "endothelial_subtype_fraction_HA_vs_other_wilcoxon.csv"),
  row.names = FALSE
)
...
write.csv(
  top_diff_df,
  file.path(RES_DIR, "endothelial_subtype_fraction_HA_vs_other_ranked_by_effect.csv"),
  row.names = FALSE
)
