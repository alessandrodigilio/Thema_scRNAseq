...
# run ranked fgsea on macrophage-subtype pseudobulk DESeq2 results
...
if (!"cell_type" %in% colnames(summary_df)) summary_df$cell_type <- summary_df$macrophage_subtype
...
cat("\n============================================================\n")
cat("Macrophage subtype fgsea complete.\n")
