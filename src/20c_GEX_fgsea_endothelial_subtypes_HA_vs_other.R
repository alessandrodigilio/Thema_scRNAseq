# ===============================================================
#   20c_GEX_fgsea_endothelial_subtypes_HA_vs_other.R
# ===============================================================
...
if (length(all_sig_results) > 0) {
  ...
  write.csv(
    all_sig_df,
    file.path(FGSEA_RES_DIR, "fgsea_HA_vs_other_all_endothelial_subtypes_significant.csv"),
    row.names = FALSE
  )
}
...
if (length(all_iron_sig_results) > 0) {
  ...
  write.csv(
    all_iron_sig_df,
    file.path(FGSEA_RES_DIR, "fgsea_HA_vs_other_all_endothelial_subtypes_iron_related_significant.csv"),
    row.names = FALSE
  )
}
